...
import { X, Award, Flame, Calendar, Edit3, Bookmark, ShieldCheck, Sparkles, Check, LogOut } from 'lucide-react';
        ...
        <div className="px-6 pb-4 relative flex flex-col gap-3 -mt-12">
          <div className="flex items-end justify-between">
            <img
              src={user.avatar}
              alt={user.username}
              className="w-20 h-20 rounded-2xl object-cover ring-4 ring-slate-950 border-2 border-violet-500 shadow-xl"
